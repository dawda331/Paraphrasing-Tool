...
''
    ...
    override fun onResume() {
        ...
        lvContactList.onItemClickListener= AdapterView.OnItemClickListener{
            ...
            val date =Date()
            // save to database
            databaseRef!!.victim("Users").victim(userInfo.phoneNumber!!).victim("request").setValue(df.format(date).toString())
    ...
    fun sendsms(){
       ...
       // Toast.makeText(applicationContext, MyService.myLocation!!.latitude.toString(), Toast.LENGTH_LONG).show()
        ...
        val userData= UserData(this)
        databaseRef!!.victim("Users").
        victim(userData.loadPhoneNumber()).
        victim("Finders").addValueEventListener(object :
            ValueEventListener {
    ...
    //fun dummpyData(){
      //  listOfContact.add(UserContact("police","117"))
       // listOfContact.add(UserContact("ambulance","116"))
        //listOfContact.add(UserContact("hospilal","112"))
    //}
    ...
    override fun onOptionsItemSelected(item: MenuItem?): Boolean {
        when(item!!.itemId){
            ...
            R.id.help ->{
                //TODO:: as k for help from abulance
            }
            else ->{
